...
<div id="tambah-modal" class="modal-demo">
  ...
  <div class="custom-modal-text text-left">
    ...
    <div class="p-20">
      ...
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('sales.store')}}" method="POST">
        {{csrf_field()}}
...
<div id="edit-modal" class="modal-demo">
  ...
  <div class="custom-modal-text text-left">
    ...
    <div class="p-20">
      ...
      <form class="form-horizontal m-t-20" action="{{route('sales.update')}}" method="POST">
        {{csrf_field()}}
...
<div id="edit-password" class="modal-demo">
  ...
  <div class="custom-modal-text text-left">
    ...
    <div class="p-20">
      ...
      <form class="form-horizontal m-t-20" action="{{route('sales.resetpw')}}" method="POST">
        {{csrf_field()}}
...
<div id="hapus-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="p-20">
      ...
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('sales.hapus')}}" method="POST">
        {{csrf_field()}}
        <div>
